...
Raw log: `results/logs/153-strip-s5-nonohz-20260923-145458.log`

## Measurements

```
EXITBENCH config rungs=L0,L2,L7 n=200000 site=kernel chunk=1024 cold=0 gpa=0x40000000 probe=
EXITBENCH rung=L0 name=rdtsc site=kernel mode=hot n=200000 min=54 p50=58 p90=58 p99=60 p999=60 max=13496 mean=57.4 stddev=59.2
EXITBENCH rung=L2 name=vmcall site=kernel mode=hot n=200000 min=1822 p50=1830 p90=1840 p99=1846 p999=4968 max=17992 mean=1837.1 stddev=176.8
EXITBENCH rung=L7 name=mmio_unbacked site=kernel mode=hot n=200000 min=7676 p50=7902 p90=7968 p99=8146 p999=13344 max=271940 mean=7926.5 stddev=801.2
EXITBENCH done rc=0
...
```
date          2026-09-23T14:55:00+00:00
