...
Raw log: `results/logs/abl-hvtimer-off-20260919-001958.log`

## Measurements

```
EXITBENCH config rungs=L0,L2,L7 n=100000 site=kernel chunk=1024 cold=0 gpa=0x40000000 probe=
EXITBENCH rung=L0 name=rdtsc site=kernel mode=hot n=100000 min=54 p50=58 p90=58 p99=60 p999=60 max=17046 mean=57.4 stddev=80.0
EXITBENCH rung=L2 name=vmcall site=kernel mode=hot n=100000 min=3774 p50=3814 p90=3828 p99=3842 p999=12234 max=255718 mean=3839.0 stddev=1213.2
EXITBENCH rung=L7 name=mmio_unbacked site=kernel mode=hot n=100000 min=27950 p50=28444 p90=28520 p99=39110 p999=46006 max=295364 mean=28647.9 stddev=2171.2
EXITBENCH done rc=0
...
```
date          2026-09-19T00:20:00-04:00
