...
Raw log: `results/logs/abl-baseline-20260919-001948.log`

## Measurements

```
EXITBENCH config rungs=L0,L2,L7 n=100000 site=kernel chunk=1024 cold=0 gpa=0x40000000 probe=
EXITBENCH rung=L0 name=rdtsc site=kernel mode=hot n=100000 min=54 p50=58 p90=58 p99=60 p999=60 max=16222 mean=57.3 stddev=64.6
EXITBENCH rung=L2 name=vmcall site=kernel mode=hot n=100000 min=3758 p50=3780 p90=3786 p99=3802 p999=12154 max=199434 mean=3804.5 stddev=1005.8
EXITBENCH rung=L7 name=mmio_unbacked site=kernel mode=hot n=100000 min=26212 p50=28536 p90=28634 p99=38454 p999=44146 max=871448 mean=28732.4 stddev=4181.8
EXITBENCH done rc=0
...
```
date          2026-09-19T00:19:51-04:00
