# 153-strip-s3-apicv-off

`qemu`, rungs `L0,L2,L7`, site `kernel`, n=200000, cold=0.
Raw log: `results/logs/153-strip-s3-apicv-off-20260923-144911.log`

## Measurements

```
EXITBENCH config rungs=L0,L2,L7 n=200000 site=kernel chunk=1024 cold=0 gpa=0x40000000 probe=
EXITBENCH rung=L0 name=rdtsc site=kernel mode=hot n=200000 min=54 p50=58 p90=58 p99=60 p999=60 max=5578 mean=57.1 stddev=16.8
EXITBENCH rung=L2 name=vmcall site=kernel mode=hot n=200000 min=2078 p50=2090 p90=2096 p99=2100 p999=2258 max=5638 mean=2092.2 stddev=45.7
EXITBENCH rung=L7 name=mmio_unbacked site=kernel mode=hot n=200000 min=8360 p50=8550 p90=8736 p99=8826 p999=11340 max=245324 mean=8587.2 stddev=581.1
EXITBENCH done rc=0
...
```
date          2026-09-23T14:49:13+00:00
