# 153-strip-s4-hvtimer-off

`qemu`, rungs `L0,L2,L7`, site `kernel`, n=200000, cold=0.
Raw log: `results/logs/153-strip-s4-hvtimer-off-20260923-144913.log`

## Measurements

```
EXITBENCH config rungs=L0,L2,L7 n=200000 site=kernel chunk=1024 cold=0 gpa=0x40000000 probe=
EXITBENCH rung=L0 name=rdtsc site=kernel mode=hot n=200000 min=54 p50=58 p90=58 p99=60 p999=60 max=328 mean=57.0 stddev=1.6
EXITBENCH rung=L2 name=vmcall site=kernel mode=hot n=200000 min=2032 p50=2042 p90=2046 p99=2052 p999=2210 max=43062 mean=2043.4 stddev=122.1
EXITBENCH rung=L7 name=mmio_unbacked site=kernel mode=hot n=200000 min=8020 p50=8254 p90=8310 p99=8440 p999=9538 max=237128 mean=8258.3 stddev=554.2
EXITBENCH done rc=0
...
```
date          2026-09-23T14:49:15+00:00
