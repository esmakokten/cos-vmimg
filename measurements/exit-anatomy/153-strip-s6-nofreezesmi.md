# 153-strip-s6-nofreezesmi

`qemu`, rungs `L2,L7`, site `kernel`, n=200000, cold=0.
Raw log: `results/logs/153-strip-s6-nofreezesmi-20260923-150457.log`

## Measurements

```
EXITBENCH config rungs=L2,L7 n=200000 site=kernel chunk=1024 cold=0 gpa=0x40000000 probe=
EXITBENCH rung=L2 name=vmcall site=kernel mode=hot n=200000 min=1628 p50=1636 p90=1646 p99=1652 p999=2358 max=20646 mean=1642.4 stddev=173.6
EXITBENCH rung=L7 name=mmio_unbacked site=kernel mode=hot n=200000 min=7348 p50=7644 p90=7708 p99=7786 p999=12772 max=295020 mean=7665.7 stddev=819.7
EXITBENCH done rc=0
