...
Raw log: `results/logs/153-strip-s0-pmu-on-20260923-144905.log`

## Measurements

```
EXITBENCH config rungs=L0,L2,L7 n=200000 site=kernel chunk=1024 cold=0 gpa=0x40000000 probe=
EXITBENCH rung=L0 name=rdtsc site=kernel mode=hot n=200000 min=54 p50=58 p90=58 p99=60 p999=60 max=4566 mean=57.0 stddev=10.2
EXITBENCH rung=L2 name=vmcall site=kernel mode=hot n=200000 min=2438 p50=2502 p90=2510 p99=2536 p999=2742 max=7570 mean=2497.4 stddev=53.7
EXITBENCH rung=L7 name=mmio_unbacked site=kernel mode=hot n=200000 min=8652 p50=8970 p90=9190 p99=9330 p999=10920 max=304894 mean=8995.6 stddev=719.0
EXITBENCH done rc=0
...
```
date          2026-09-23T14:49:07+00:00
