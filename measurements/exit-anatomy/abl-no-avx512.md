...
Raw log: `results/logs/abl-no-avx512-20260919-001951.log`

## Measurements

```
EXITBENCH config rungs=L0,L2,L7 n=100000 site=kernel chunk=1024 cold=0 gpa=0x40000000 probe=
EXITBENCH rung=L0 name=rdtsc site=kernel mode=hot n=100000 min=54 p50=58 p90=58 p99=60 p999=60 max=13866 mean=57.3 stddev=54.0
EXITBENCH rung=L2 name=vmcall site=kernel mode=hot n=100000 min=3758 p50=3774 p90=3782 p99=3788 p999=12094 max=229802 mean=3798.8 stddev=950.2
EXITBENCH rung=L7 name=mmio_unbacked site=kernel mode=hot n=100000 min=26160 p50=28348 p90=28412 p99=38398 p999=43976 max=575866 mean=28527.0 stddev=2487.2
EXITBENCH done rc=0
